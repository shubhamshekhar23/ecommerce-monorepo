...
- [x] **2. Bulkhead Pattern (resource pool isolation)**
...
- [x] **3. Token Bucket rate limiting algorithm**
  → [phase-2.1-resilience-patterns.md](./phase-2.1-resilience-patterns.md)
...
- [x] **4. Fan-In Pattern (fulfillment confirmations)**
  → [phase-2.1-resilience-patterns.md](./phase-2.1-resilience-patterns.md)
...
- [x] **5. Leader Election (distributed singleton jobs)**
...
- [x] **6. Canary Deployment (Istio + Argo Rollouts)**
  → [phase-8.1-deployment-advanced.md](./phase-8.1-deployment-advanced.md)
...
- [x] **7. Rule-Based Architecture — Promotions Engine**
...
- [x] **8. Interpreter Pattern — Discount Rule DSL**
  → [phase-7.4-business-rules.md](./phase-7.4-business-rules.md)
...
- [x] **9. True Event Sourcing (evolve existing OrderEvent)**
...
- [x] **10. Microkernel Pattern — Payment Provider Plugins**
  → [phase-9.5-architectural-patterns.md](./phase-9.5-architectural-patterns.md)
...
- [x] **11. Pipe and Filter — Order Processing Pipeline**
  → [phase-9.5-architectural-patterns.md](./phase-9.5-architectural-patterns.md)
