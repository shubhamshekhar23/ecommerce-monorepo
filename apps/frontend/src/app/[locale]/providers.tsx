...
// Guard with typeof window so Turbopack's server bundle evaluation doesn't hit
// browser-only Sentry APIs (browserTracingIntegration lives in the client bundle only).
